...
Given the `Account` model defined in the [Documents](documents.md) section, a PyMongo collection object, and a record stored in the database we can retrieve it back out and get the result as an ``Account`` instance:
